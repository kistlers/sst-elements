...
#ifndef _H_EMBER_SEND
#define _H_EMBER_SEND
...
class EmberSendGenerator : public EmberMessagePassingGenerator {
   public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(EmberSendGenerator, "ember", "SendMotif", SST_ELI_ELEMENT_VERSION(1, 0, 0),
                                          "Performs a Ping-Pong Motif", SST::Ember::EmberGenerator)
   ...
   public:
    EmberSendGenerator(SST::ComponentId_t, Params& params);
